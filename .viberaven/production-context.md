...
- Danger: Authenticated paid continuity and billing behavior remain unproven in the live environment. Polar currently reports no payout account, no organization country, and `checkout_payments=false`; enabling checkout before provider onboarding and signed webhook evidence would be both unusable and unverifiable.
